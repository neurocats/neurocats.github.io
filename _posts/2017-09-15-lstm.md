...
![f]()
%picture of LSTM Memory Cell
\begin{figure}[H]
\includegraphics[scale=0.5]{LSTM_block.pdf} 
\caption{LSTM Memory Block $c_{j}$ with one Cell.}
\end{figure}
...
![f]()
%picture of LSTM Memory Cell with forget gate
\begin{figure}[H]
\includegraphics[scale=0.5]{LSTM_forget.pdf} 
\caption{LSTM Memory Block $c_{j}$ with a Forget Gate.}
\end{figure}
